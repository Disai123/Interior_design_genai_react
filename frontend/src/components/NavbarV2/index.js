            ...
            <div className="dropdown" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="dropdown33" style={{ minWidth: '280px' }}>
                  <div className="" style={{ cursor: 'default', padding: '5px', paddingLeft: '10px', fontWeight: 600 }}>{userName}</div>  
                  <div className="" style={{ cursor: 'default', padding: '5px', paddingLeft: '10px' }}>{email}</div>
                  <div className="dropdown-item" style={{ fontWeight: 600 }} onClick={() => navigate('#')}>Account & Billing</div>
